...
type_checker_type_t * type_checker_registry_parse_struct(type_checker_registry_t * tr, token_buffer_t * token_buffer, syntax_tree_node_list_node_t * struct_node) {
    ...
    if (
        ...
        while (true) {
            ...
            type_checker_type_t * type = type_checker_registry_parse(tr, token_buffer, member_decl_type_node);
        ...
        entry->type.derived_type.structure.subtypes = pkcc_realloc(member_types, member_type_count * sizeof(type_checker_type_t *));
