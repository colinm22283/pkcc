...
OBJS+=$(OBJ_DIR)/java/java_primitive_stringify.o
OBJS+=$(OBJ_DIR)/java/java_prefix.o
OBJS+=$(OBJ_DIR)/java/java_default_value.o
OBJS+=$(OBJ_DIR)/java/cast.o
OBJS+=$(OBJ_DIR)/java/variable_registry.o
OBJS+=$(OBJ_DIR)/java/add_lib_definitions.o
OBJS+=$(OBJ_DIR)/java/label_manager.o
OBJS+=$(OBJ_DIR)/java/generators/globals.o
OBJS+=$(OBJ_DIR)/java/generators/functions.o
OBJS+=$(OBJ_DIR)/java/generators/expression.o
OBJS+=$(OBJ_DIR)/java/generators/code_list.o
OBJS+=$(OBJ_DIR)/java/generators/code_line.o
OBJS+=$(OBJ_DIR)/java/generators/statement.o
OBJS+=$(OBJ_DIR)/java/generators/local_var.o